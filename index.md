...
<li><strong>目標設定</strong>と<strong>効果測定</strong>が<strong>あいまい</strong></li>
<li><strong>批判</strong>があると開き直る・<strong>暴言</strong>を吐く</li>
</ul>
...
樋渡啓祐は施策の計画段階や議会での採決において、充分な説明を行い共に施策を進めていくという考えを持っていません。
（要具体的発言例）

これは一見、強いリーダーシップがあると誤解される部分です。しかし、一部の人のみで考えられた施策は見落としなどにより問題点が多く発生します。それを後からでも修正できればいいのですが、樋渡啓祐は人の意見をうまく取り入れることができないため、より良い結果を生む可能性を潰しています。

### 「公募によらず、県外業者を連れてくる」のは、どうしてダメなの？ {.lead}

多くの自治体では一定の規模の事業の場合、原則として入札や公募によって契約する業者を選びます。

これは業者に競わせることにより、より良いものをより安く調達するためですが、樋渡啓祐の主要な施策ではこれは行われず**特定の業者との契約ありき**[^1]で計画を進めていきます。公募することにより、より安くより良い企画があったかもしれないのにです。
...
### 「目標設定と効果測定があいまい」なのは、どうしてダメなの？ {.lead}

（TODO: 書く）

### 「批判があると開き直る・暴言を吐く」のは、どうしてダメなの？ {.lead}
...
直前に市長選があったにも関わらず、教育に関わる重要施策を秘密にして選挙に臨み、当選直後に発表するという手法をとっています。
また、通常自治体おいては金額が大きくなる場合、公募によって契約業者を決めますがそれを行っていません。
...
<li>同人物を教育長に任命しようとした鎌倉市では任命を巡り様々な問題や議論が起きた</li>
</ul>

-----

過去に問題のあった人物を任命しています。何故この人を登用したのでしょうか。  
...
-----
基本構想発表後、多くの方から様々な指摘がされましたが、その多くは無視されました。また、改装後、初年度は100万人近い来場者を記録しましたが、その後来場者は減り続けています。
...
一方的な発信のみで、相手の話を聞いて対応するということが出来ません。
